...
export function Slideshow() {
  ...
  const goNext = useCallback(() => goToSlide(currentSlide + 1, "right"), [currentSlide, goToSlide])
  const goPrev = useCallback(() => goToSlide(currentSlide - 1, "left"), [currentSlide, goToSlide])
